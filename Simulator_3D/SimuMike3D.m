...
% -------------------------------------------------------------------------   
   methods
       ...
       function obj = SimuMike3D(Rocket, Environment, SimOutput)
           if nargin == 0
...
% -------------------------------------------------------------------------      
   methods(Access = protected)
        ...
        function marge = Dynamics_6DOF(obj, t, s)
            ...
            % Rocket Inertia
            [M,dMdt,Cm,~,I_L,~,I_R,~] = Mass_Properties(t,obj.Rocket,'Linear');
...
% -------------------------------------------------------------------------           
    methods(Access = public)
        ...
        % Flight Simulation
        % ---------------------------
        function [marge] = FlightSim(obj, tspan, arg2, arg3, arg4, arg5)
            ...
            % integration
            marge = obj.Dynamics_6DOF(tspan(1),S0);
