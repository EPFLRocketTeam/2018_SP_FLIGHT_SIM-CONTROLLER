...
plot3(r_ellipse(:,1) + X0,r_ellipse(:,2) + Y0,0*r_ellipse(:,2),'DisplayName', '95% confidence Interval','LineWidth',5);
plot3(data(:,1), data(:,2),0*data(:,2),'DisplayName', 'noised landing','LineWidth',3);
