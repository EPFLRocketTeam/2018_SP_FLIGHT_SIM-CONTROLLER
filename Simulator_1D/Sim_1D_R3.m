...
[T, X] = ode45(@(t,x) Rocket_Kinematic_R3(t, x, Rocket, Env, AB_drag, theta, 1, 1),...
               tspan, x0, Option);
[T1, X1] = ode45(@(t,x) Rocket_Kinematic_R3(t, x, Rocket, Env, AB_drag, theta, 1, 1.1),...
               tspan, x0, Option);
[T2, X2] = ode45(@(t,x) Rocket_Kinematic_R3(t, x, Rocket, Env, AB_drag, theta, 1, 0.9),...
               tspan, x0, Option);
