classdef multilayerwindSimulator3D_ode113 < handle
...
% -------------------------------------------------------------------------   
   methods
       ...
       function obj = multilayerwindSimulator3D_ode113(Rocket, Environment, SimOutput)
           if nargin == 0
    ...
    methods(Access = public)
        ...
        function [T1, S1] = RailSim(obj)
           ...
           % Initial Conditions
            ...
            % integration
            [T1,S1] = ode113(@(t,x) obj.Dynamics_Rail_1DOF(t,x),tspan,X0, Option); 
        ...
        function [T2, S2, T2E, S2E, I2E] = FlightSim(obj, tspan, arg2, arg3, arg4, arg5)
            ...
            % integration
            [T2,S2, T2E, S2E, I2E] = ode113(@(t,s) obj.Dynamics_6DOF(t,s),tspan,S0, Option);
        ...
        function [T3, S3, T3E, S3E, I3E] = DrogueParaSim(obj, T0, X0, V0)
            ...
            % integration
            [T3,S3, T3E, S3E, I3E] = ode113(@(t,s) obj.Dynamics_Parachute_3DOF(t,s,obj.Rocket,obj.Environment, M, 0),tspan,S0, Option);
        ...
        function [T4, S4, T4E, S4E, I4E] = MainParaSim(obj, T0, X0, V0)
            ...
            % integration
            [T4, S4, T4E, S4E, I4E] = ode113(@(t,s) obj.Dynamics_Parachute_3DOF(t,s,obj.Rocket,obj.Environment, M, 1),tspan,S0, Option);
        ...
        function [T5, S5, T5E, S5E, I5E] = CrashSim(obj, T0, X0, V0)
            ...
            % integration
            [T5,S5, T5E, S5E, I5E] = ode113(@(t,s) obj.Dynamics_3DOF(t,s,obj.Rocket,obj.Environment),tspan,S0, Option);
